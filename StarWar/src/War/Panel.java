...
public class Panel extends JPanel {
	...
	public Panel() {
		...
		brill = new Timer(25, new ListenerBrill());
		start = new Timer(25, new ListenerStart());
...
//		backgroundSound .play();
	...
	private class ListenerStart implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			setFocusable(true);
			myBuffer.drawImage(startBackGround.getImage(), 0, 0, 1440, 900, null);
			myBuffer.setColor(Color.GRAY);
			myBuffer.fillRect(160, 370, 500, 100);
			myBuffer.fillRect(160, 640, 500, 100);
			myBuffer.setFont(new Font("Serif", Font.BOLD, 70));
			myBuffer.setColor(Color.BLACK);
			myBuffer.drawString("遊戲開始", 270, 430);
			myBuffer.drawString("遊戲說明", 270, 700);
			if (homeC == 0) {
				myBuffer.setColor(Color.YELLOW);
				myBuffer.setStroke(new BasicStroke(10.0f));
				myBuffer.drawRect(160, 360, 515, 120);
			}
			if (homeC == 1) {
				myBuffer.setColor(Color.YELLOW);
				myBuffer.setStroke(new BasicStroke(10.0f));
				myBuffer.drawRect(160, 630, 515, 120);
...
//				killAudio.play();
	...
	private class KeyStart extends KeyAdapter {
